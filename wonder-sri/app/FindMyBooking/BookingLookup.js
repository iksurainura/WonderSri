  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiUrl = isGmail
        ? `https://wondersri-com-backend.onrender.com/api/v1/bookings/booking-by-email/${input}` // Endpoint for Gmail
        : `https://wondersri-com-backend.onrender.com/api/v1/bookings/booking-by-code/${input}`; // Endpoint for booking code
